...
class todo:
    def __init__ (self, root):
        ...
        self.label3=Label(self.root, text='Tasks',font='ariel, 18 bold', width=10,bd=5, bg='blue', fg='black')
        ...
        self.button.place(x=38, y=180)
        self.button2= Button(self.root, text ="Delete", font='sarif, 20 bold italic', width=10,bd=5, bg="blue", fg='black', command=delete)
